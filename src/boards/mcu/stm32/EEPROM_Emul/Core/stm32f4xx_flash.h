...
#undef FLASH_BUSY
#undef FLASH_ERROR_PGS
#undef FLASH_ERROR_PGP
#undef FLASH_ERROR_PGA
#undef FLASH_ERROR_WRP
#undef FLASH_ERROR_PROGRAM
#undef FLASH_ERROR_OPERATION
#undef FLASH_COMPLETE 
#undef IS_FLASH_LATENCY
#undef IS_VOLTAGERANGE
#undef IS_FLASH_SECTOR
#undef IS_FLASH_ADDRESS
#undef IS_OB_STOP_SOURCE
#undef IS_OB_STDBY_SOURCE
#undef FLASH_IT_EOP
#undef FLASH_IT_ERR
#undef FLASH_FLAG_EOP
#undef FLASH_FLAG_OPERR
#undef FLASH_FLAG_WRPERR
#undef FLASH_FLAG_PGAERR
#undef FLASH_FLAG_PGPERR
#undef FLASH_FLAG_PGSERR
#undef FLASH_FLAG_BSY
#undef FLASH_PSIZE_BYTE
#undef FLASH_PSIZE_HALF_WORD
#undef FLASH_PSIZE_WORD
#undef FLASH_PSIZE_DOUBLE_WORD
#undef CR_PSIZE_MASK
#undef FLASH_KEY1
#undef FLASH_KEY2
#undef FLASH_OPT_KEY1
#undef FLASH_OPT_KEY2
#undef ACR_BYTE0_ADDRESS
#undef OPTCR_BYTE0_ADDRESS
#undef OPTCR_BYTE1_ADDRESS
#undef OPTCR_BYTE2_ADDRESS
...
FLASH_Status FLASH_WaitForLastOperation_StdPeriph(void);
